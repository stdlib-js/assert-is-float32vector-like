...
```javascript
isFloat32VectorLike = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/assert-is-float32vector-like@v0.1.0-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/assert-is-float32vector-like/actions/workflows/test.yml/badge.svg?branch=v0.1.0
[test-url]: https://github.com/stdlib-js/assert-is-float32vector-like/actions/workflows/test.yml?query=branch:v0.1.0
